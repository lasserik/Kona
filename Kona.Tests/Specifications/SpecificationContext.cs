...
{
    public static class SpecificationContext
    {
        ...
        public static IEnumerable<ITestCommand> ToTestCommands(MethodInfo method)
        {
            try
            {
        ...
        class ActionTestCommand : ITestCommand
        {
            ...
            public ActionTestCommand(MethodInfo method, string name, IEnumerable<Action> actions)
            {
                this.method = method;
